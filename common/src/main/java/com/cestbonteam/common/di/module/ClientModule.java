...
import com.cestbonteam.common.http.fastjson.ConverterFastJson;
import com.cestbonteam.common.http.fastjson.FastjsonSpeaker;
...
public class ClientModule {
    ...
    Retrofit provideRetrofit(Application application, @Nullable RetrofitConfiguration configuration, Retrofit.Builder builder, OkHttpClient client
        ...
        builder
                ...
                .addConverterFactory(new ConverterFastJson());//使用Fast json
